...
# from statespaces.extensions.legt.legt import legt_gbt_forward, legt_gbt_backward, legt_gbt_forward_t, legt_gbt_backward_t
...
from statespaces.models.functional.toeplitz import causal_convolution, causal_convolution_inverse, causal_convolution_inverse_wrong, construct_toeplitz
...
try:
    from statespaces.extensions.trid.trid import trid_gbt_forward, trid_gbt_backward, trid_solve
except:
    pass
