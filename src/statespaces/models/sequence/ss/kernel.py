...
import statespaces.models.hippo.hippo as hippo
import statespaces.models.sequence.ss.dplr as dplr
from statespaces.models.functional.krylov import krylov, power
import statespaces.utils.train

log = statespaces.utils.train.get_logger(__name__)

try: # Try CUDA extension
    from statespaces.extensions.cauchy.cauchy import cauchy_mult
...
try:
    import pykeops
    from statespaces.models.functional.cauchy import cauchy_conj
    from statespaces.models.functional.vandermonde import log_vandermonde, log_vandermonde_transpose

    has_pykeops = True
    log.info("Pykeops installation found.")
except ImportError:
    has_pykeops = False
    from statespaces.models.functional.cauchy import cauchy_naive
    from statespaces.models.functional.vandermonde import log_vandermonde_naive as log_vandermonde
    from statespaces.models.functional.vandermonde import log_vandermonde_transpose_naive as log_vandermonde_transpose
