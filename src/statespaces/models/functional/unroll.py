...
from statespaces.models.functional.toeplitz import triangular_toeplitz_multiply, triangular_toeplitz_multiply_padded
from statespaces.utils import bitreversal_po2
